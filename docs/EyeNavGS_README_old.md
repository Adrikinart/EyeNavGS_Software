...
5. Download the specific version of Meta Quest Link app: https://www.oculus.com/download_app/?id=1582076955407037

6. Then you should start with a developer account in the Meta Quest Link and your headset: https://auth.oculus.com/login/?redirect_uri=https%3A%2F%2Fdeveloper.oculus.com%2Fmanage (Creating developer account needs two-step authentication or adding payment.)

7. When you logged in, you should open the developer mode and eye tracking permission. 
   ![quest-link](./docs/img/quest_link_setting.png)

8. Make sure that you have activated the eye tracking function on the Quest pro headset and calibrated.
...
6. If you are experiencing lags in the headset, try to lower the rendering resolution by changing the `Down scale factor` slider value.
   **Linux (through Steam):**
7. Install Steam and SteamVR
8. Make SteamVR the OpenXR default runtime (Settings > OpenXR > SET STEAMVR AS OPENXR RUNTIME)
9. Restart SteamVR
10. Run `gaussianViewer -m <dataset_path> --rendering-mode 2`
