	...
	*/
	...
	public:
		...
		*/
		...
		bool isMonocular; //camera loader is Monocular mode
		void loadCsv(const std::string& filePath, int w = 1920, int h = 1080);
		/**
		...
		*/
		...
		void saveCameraDataToCSV(const std::string& filename) const;
